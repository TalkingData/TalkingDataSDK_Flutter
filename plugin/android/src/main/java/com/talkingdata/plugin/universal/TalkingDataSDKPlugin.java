package com.talkingdata.plugin.universal;
...
/** TalkingDataUniversalPlugin */
public class TalkingDataSDKPlugin implements MethodCallHandler {
  private Context context;

  private TalkingDataSDKPlugin(Context context){
    this.context = context;
  }

  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "TalkingData_Plugin");
    channel.setMethodCallHandler(new TalkingDataSDKPlugin(registrar.context().getApplicationContext()));
  }

  public static void init(Context ctx, String appID, String channelID,String custom) {
  ...
  public void onMethodCall(MethodCall call, MethodChannel.Result result) {
    switch (call.method) {
      case "init":
        ...
        break;
      case "getDeviceID":
        result.success(TalkingDataSDK.getDeviceId(context));
        break;
      case "getOAID":
        result.success(TalkingDataSDK.getOAID(context));
        break;
      case "onPageBegin":
        TalkingDataSDK.onPageBegin(context, (String) call.argument("pageName"));
        break;
      case "onPageEnd":
        TalkingDataSDK.onPageEnd(context, (String) call.argument("pageName"));
        break;
      ...
      case "onEvent":
        ...
        TalkingDataSDK.onEvent(context,
