...
class TalkingDataSDK {
  static const MethodChannel _channel =
      const MethodChannel('TalkingData_Plugin');

  static Future<void> init(String appID, String channelID, String custom) async{
  ...
  static Future<void> onEvent(
      String eventId, double value, Map params) async {
  ...
  static Future<void> onLogin(
      String profileId, TalkingDataProfile profile) async {
