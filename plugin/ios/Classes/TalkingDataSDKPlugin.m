...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"TalkingData_Plugin"
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if([@"init" isEqualToString:call.method]){
        ...
        NSString * profileName = [self checkArgument:call.arguments forKey:@"profileName" ofType:[NSString class]];
        ...
        NSString * profileName = [self checkArgument:call.arguments forKey:@"profileName" ofType:[NSString class]];
        NSString * profileType = [self checkArgument:call.arguments forKey:@"profileType" ofType:[NSString class]];
        NSString * profileGender = [self checkArgument:call.arguments forKey:@"profileGender" ofType:[NSString class]];
        NSNumber * profileAge = [self checkArgument:call.arguments forKey:@"profileAge" ofType:[NSNumber class]];
        NSObject * profileValue1 = [self checkArgument:call.arguments forKey:@"profileValue1" ofType:[NSObject class]];
        NSObject * profileValue2 = [self checkArgument:call.arguments forKey:@"profileValue2" ofType:[NSObject class]];
        NSObject * profileValue3 = [self checkArgument:call.arguments forKey:@"profileValue3" ofType:[NSObject class]];
        NSObject * profileValue4 = [self checkArgument:call.arguments forKey:@"profileValue4" ofType:[NSObject class]];
        NSObject * profileValue5 = [self checkArgument:call.arguments forKey:@"profileValue5" ofType:[NSObject class]];
        NSObject * profileValue6 = [self checkArgument:call.arguments forKey:@"profileValue6" ofType:[NSObject class]];
        NSObject * profileValue7 = [self checkArgument:call.arguments forKey:@"profileValue7" ofType:[NSObject class]];
        NSObject * profileValue8 = [self checkArgument:call.arguments forKey:@"profileValue8" ofType:[NSObject class]];
        NSObject * profileValue9 = [self checkArgument:call.arguments forKey:@"profileValue9" ofType:[NSObject class]];
        NSObject * profileValue10 = [self checkArgument:call.arguments forKey:@"profileValue10" ofType:[NSObject class]];
        TalkingDataProfileType type = [self profileTypeConvert:profileType];
...
//#error 记得更新最新的.a和.h，然后打开下边的注释。
        ...
        result(deviceid);
             ...
             TalkingDataSearch * search = [[TalkingDataSearch alloc]init];
             ...
             TalkingDataTransaction * transaction = [[TalkingDataTransaction alloc]init];
